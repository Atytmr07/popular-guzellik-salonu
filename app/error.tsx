      ...
      <div className="w-full max-w-2xl rounded-[32px] border border-white/10 bg-white/5 p-10 text-center shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <button
            type="button"
            onClick={reset}
            className="luxury-button inline-flex min-h-12 items-center rounded-full bg-[#C41E3A] px-7 py-4 text-sm font-semibold uppercase tracking-[0.22em] text-white shadow-[0_12px_30px_rgba(196,30,58,0.18)] transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(196,30,58,0.4)]"
          >
            Tekrar Dene
          </button>
          <a
            href="/"
            className="luxury-button inline-flex min-h-12 items-center rounded-full border border-white/15 bg-white/5 px-7 py-4 text-sm font-medium uppercase tracking-[0.22em] text-gray-100 backdrop-blur-md transition-all duration-300 ease-out hover:border-[#C41E3A]/50 hover:bg-white/8 hover:text-[#FF8FA3]"
          >
            Ana Sayfa
          </a>
        </div>
