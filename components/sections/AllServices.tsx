...
const services = [
  ...
  },
  {
    ...
    media: [
      ...
      { type: "video", src: "/sac-kesim/sac-kesim8.mp4", label: "Saç Kesim 08" },
      { type: "video", src: "/sac-kesim/sac-kesim9.mp4", label: "Saç Kesim 09" },
      { type: "video", src: "/sac-kesim/sac-kesim10.mp4", label: "Saç Kesim 10" },
      { type: "video", src: "/sac-kesim/sac-kesim11.mp4", label: "Saç Kesim 11" },
      { type: "video", src: "/sac-kesim/sac-kesim12.mp4", label: "Saç Kesim 12" },
      { type: "video", src: "/sac-kesim/sac-kesim13.mp4", label: "Saç Kesim 13" },
      { type: "video", src: "/sac-kesim/sac-kesim14.mp4", label: "Saç Kesim 14" },
      { type: "video", src: "/sac-kesim/sac-kesim15.mp4", label: "Saç Kesim 15" },
      { type: "video", src: "/sac-kesim/sac-kesim16.mp4", label: "Saç Kesim 16" },
    ] as MediaFile[],
  },
  {
    id: "perma-sac",
